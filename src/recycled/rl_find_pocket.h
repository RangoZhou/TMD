...
public:
    ...
    void SetValue (const parameter P, const tmd::Atoms& atoms) {
        ...
        for(const tmd::Atom& atom : atoms) {
            ...
            a.type = atom.get_sybyl_type_name();
            a.resi_name = atom.get_res_name();
            a.q = atom.get_charge();
...
const vector<pocket_info> lz_find_pocket(const tmd::RNA& yz_rna, const tmd::Ligand& yz_lig) {
    ...
    parameter P;
    P.SetSphere("/home/yuanzhe/TMD/src/res/sphere.dat");
    P.SetAngle();
    ...
    lig.SetValue(P,yz_lig.get_atoms_reference());
    ...
    rec.SetValue(P,yz_rna.get_atoms_reference());
